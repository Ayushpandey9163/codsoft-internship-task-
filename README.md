Below is a sample README file of this GitHub repository that contains four tasks: Number Guessing Game, Simple Calculator, Tic-Tac-Toe Game, and To-Do List, all written in C++.
